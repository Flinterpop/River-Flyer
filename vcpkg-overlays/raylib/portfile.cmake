...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DCUSTOMIZE_BUILD=ON
        # raylib 6.0's ParseConfigHeader.cmake misreads the new "#define SUPPORT_X 0"
        # style in config.h and turns EVERY flag on. These two change run-time
        # behaviour: custom frame control makes EndDrawing() stop swapping, polling
        # and pacing (the window never paints and never responds), and busy-wait
        # pins a core. Force them back to upstream defaults.
