...
Compress-Archive build\Release\scroller.exe RiverFlyer-v0.2.0-win64.zip
gh release create v0.2.0 RiverFlyer-v0.2.0-win64.zip --title "v0.2.0" --notes-file notes.md
```
