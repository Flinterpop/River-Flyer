...
[release-badge]: https://img.shields.io/badge/release-v0.8.0-blue
...
gh release create v0.8.0 RiverFlyer-v0.8.0-win64.zip RiverFlyer-v0.8.0-web.zip RiverFlyer-v0.8.0-android.apk --title "v0.8.0" --notes-file notes.md
```
